...
FFMPEG_CONFIGURATION=--enable-memalign-hack --target-os=mingw32 --enable-static --disable-shared --enable-libfaac --disable-debug --build-suffix=cu --enable-gpl --enable-nonfree --enable-libmp3lame --extra-cflags=-I/C/Mark/Development/DirectEncode/Libraries/faac/include -I/C/Mark/Development/DirectEncode/Libraries/lame-398/include --extra-ldflags=-L/C/Mark/Development/DirectEncode/Libraries/faac/libfaac/.libs -L/C/Mark/Development/DirectEncode/Libraries/lame-398/libmp3lame/.libs -mno-cygwin
prefix=/usr/local
...
LN_S=ln -sf
STRIP=strip
OPTFLAGS= -D_ISOC99_SOURCE -D_POSIX_C_SOURCE=200112 -I/C/Mark/Development/DirectEncode/Libraries/faac/include -I/C/Mark/Development/DirectEncode/Libraries/lame-398/include -std=c99 -fomit-frame-pointer -Wdeclaration-after-statement -Wall -Wno-switch -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wtype-limits -Wundef -O3 -fno-math-errno -fno-signed-zeros
VHOOKCFLAGS=-fPIC
LDFLAGS=  -L/C/Mark/Development/DirectEncode/Libraries/faac/libfaac/.libs -L/C/Mark/Development/DirectEncode/Libraries/lame-398/libmp3lame/.libs -mno-cygwin -Wl,--warn-common -Wl,--as-needed -Wl,-rpath-link,$(BUILD_ROOT)/libpostproc -Wl,-rpath-link,$(BUILD_ROOT)/libswscale -Wl,-rpath-link,$(BUILD_ROOT)/libavfilter -Wl,-rpath-link,$(BUILD_ROOT)/libavdevice -Wl,-rpath-link,$(BUILD_ROOT)/libavformat -Wl,-rpath-link,$(BUILD_ROOT)/libavcodec -Wl,-rpath-link,$(BUILD_ROOT)/libavutil -Wl,-Bsymbolic
...
EXTRALIBS=  -lm -lfaac -lmp3lame -lm -lws2_32 -lvfw32
ARCH=x86
ARCH_X86=yes
ARCH_X86_32=yes
HAVE_AMD3DNOW=yes
...
SRC_PATH="/c/Mark/Development/DirectEncode/Libraries/ffmpeg-0.5"
SRC_PATH_BARE=/c/Mark/Development/DirectEncode/Libraries/ffmpeg-0.5
BUILD_ROOT="/c/Mark/Development/DirectEncode/Libraries/ffmpeg-0.5"
