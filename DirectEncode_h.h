...
#ifndef __IDirectEncodeVB_FWD_DEFINED__
#define __IDirectEncodeVB_FWD_DEFINED__
typedef interface IDirectEncodeVB IDirectEncodeVB;
#endif 	/* __IDirectEncodeVB_FWD_DEFINED__ */
...
#ifndef __DirectEncodeVB_FWD_DEFINED__
#define __DirectEncodeVB_FWD_DEFINED__

#ifdef __cplusplus
typedef class DirectEncodeVB DirectEncodeVB;
#else
typedef struct DirectEncodeVB DirectEncodeVB;
#endif /* __cplusplus */

#endif 	/* __DirectEncodeVB_FWD_DEFINED__ */
...
enum _VideoOutputFormat
	...
	VIDEOFORMAT_VP6	= VIDEOFORMAT_FLV + 1
    }	VideoOutputFormat;
...
#ifndef __IDirectEncodeVB_INTERFACE_DEFINED__
#define __IDirectEncodeVB_INTERFACE_DEFINED__

/* interface IDirectEncodeVB */
/* [unique][helpstring][dual][uuid][object] */ 


EXTERN_C const IID IID_IDirectEncodeVB;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("587A41A2-FE3D-4BE0-A616-793961CAF7AC")
    IDirectEncodeVB : public IDispatch
    {
    public:
        virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE PassThru( 
            /* [in] */ long nVal) = 0;
    ...
    typedef struct IDirectEncodeVBVtbl
    {
        BEGIN_INTERFACE
        ...
        /* [helpstring][id] */ HRESULT ( STDMETHODCALLTYPE __RPC_FAR *PassThru )( 
            IDirectEncodeVB __RPC_FAR * This,
            /* [in] */ long nVal);
    ...
    interface IDirectEncodeVB
    {
        CONST_VTBL struct IDirectEncodeVBVtbl __RPC_FAR *lpVtbl;
    };
...
#define IDirectEncodeVB_QueryInterface(This,riid,ppvObject)	\
    (This)->lpVtbl -> QueryInterface(This,riid,ppvObject)

#define IDirectEncodeVB_AddRef(This)	\
    (This)->lpVtbl -> AddRef(This)

#define IDirectEncodeVB_Release(This)	\
    (This)->lpVtbl -> Release(This)


#define IDirectEncodeVB_GetTypeInfoCount(This,pctinfo)	\
    (This)->lpVtbl -> GetTypeInfoCount(This,pctinfo)

#define IDirectEncodeVB_GetTypeInfo(This,iTInfo,lcid,ppTInfo)	\
    (This)->lpVtbl -> GetTypeInfo(This,iTInfo,lcid,ppTInfo)

#define IDirectEncodeVB_GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId)	\
    (This)->lpVtbl -> GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId)

#define IDirectEncodeVB_Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr)	\
    (This)->lpVtbl -> Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr)


#define IDirectEncodeVB_PassThru(This,nVal)	\
    (This)->lpVtbl -> PassThru(This,nVal)
...
#endif 	/* __IDirectEncodeVB_INTERFACE_DEFINED__ */
...
EXTERN_C const CLSID CLSID_DirectEncodeVB;

#ifdef __cplusplus

class DECLSPEC_UUID("02E4605E-D632-4249-AA9F-3B215BE86981")
DirectEncodeVB;
#endif
